...
[[maybe_unused]] static bool buffer_clone_with_suffix(const makocode::ByteBuffer& base,
                                     const char* suffix,
...
[[maybe_unused]] static bool format_scale_label(double factor, char* out, usize out_size) {
    if (!out || out_size < 3u) {
        return false;
    }
    if (factor <= 0.0) {
...
[[maybe_unused]] static bool build_page_base_name(makocode::ByteBuffer& buffer,
                                 u64 test_case_index,
                                 const char* prefix,
...
[[maybe_unused]] static bool buffer_store_bits_with_count(const u8* data,
                                         u64 bit_count,
                                         makocode::ByteBuffer& output) {
    output.release();
...
[[maybe_unused]] static bool ppm_scale_integer(const makocode::ByteBuffer& input,
                              u32 factor,
                              makocode::ByteBuffer& output) {
    if (factor == 0u) {
        return false;
...
[[maybe_unused]] static bool ppm_scale_fractional_axes(const makocode::ByteBuffer& input,
                                      double factor_x,
                                      double factor_y,
                                      makocode::ByteBuffer& output) {
...
[[maybe_unused]] static bool ppm_scale_fractional(const makocode::ByteBuffer& input,
                                                  double factor,
                                                  makocode::ByteBuffer& output) {
...
[[maybe_unused]] static bool ensure_frame_bits_fit_single_page(ImageMappingConfig& mapping,
...
[[maybe_unused]] static bool ppm_apply_wavy_ripple(const makocode::ByteBuffer& input,
...
[[maybe_unused]] static bool compute_frame_bit_count(const ImageMappingConfig& mapping,
                                    usize payload_size,
                                    u64 seed,
                                    double ecc_redundancy,
                                    const char* password,
...
[[maybe_unused]] static bool validate_ecc_random_bit_flips(const makocode::ByteBuffer& original_payload,
...
[[maybe_unused]] static void append_number_ascii(u64 value, char buffer[32]) {
    u64_to_ascii(value, buffer, 32);
}

[[maybe_unused]] static bool ensure_directory(const char* path)
{
    struct stat st;
    if (stat(path, &st) == 0) {
...
[[maybe_unused]] static bool write_ppm_fixture(const char* path,
                              unsigned width,
                              unsigned height,
...
[[maybe_unused]] static bool write_invalid_maxval_fixture(const char* path)
{
    int fd = creat(path, 0600);
...
[[maybe_unused]] static bool write_buffer_to_directory(const char* directory,
...
[[maybe_unused]] static bool extract_ppm_pixels(const makocode::ByteBuffer& ppm,
                               unsigned& width,
                               unsigned& height,
